...
func (a *App) registerRoutes() {
	...
	postHandler := handler.NewPostHandler(service.NewPostService(repo), a.Storage, a.Logger)
	...
	me.Get("/posts", postHandler.GetMyPosts)
	me.Get("/news", newsHandler.GetMyNews)
	me.Get("/events", eventHandler.GetMyEvents)
	me.Get("/post-responses", postResponseHandler.GetMyResponses)
	...
	news.Delete("/:id/photo", newsHandler.DeleteNewsPhoto)
	...
	events.Delete("/:id/photo", eventHandler.DeleteEventPhoto)
